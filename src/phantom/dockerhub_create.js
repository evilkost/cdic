...
casper.waitForSelector(empty_description_selector, function() {
    ...
    this.wait(2000);
    this.captureSelector("202_form_before_submit.png", x("(//form)[2]"));
    this.sendKeys(ta_selector, "see README.md");
    this.wait(500);
    this.captureSelector("203_ta_form_before_submit.png", ta_selector);
    this.click(create_button_selector);
    this.wait(1500);
    this.captureSelector("204_after_submit.png", create_button_selector);
